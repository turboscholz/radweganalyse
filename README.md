...
into a GPX file for graphical analysis. Check for dependendies below.
...
Then, execute the script `radweganalyse.sh` in the same directory where you have placed
the CSV files.
...
Executing `radweganalyse.py --help` will show you a number of possible script options.
